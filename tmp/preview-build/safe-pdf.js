...
exports.generateSafeDraftPdf = generateSafeDraftPdf;
...
function drawWrappedText({ page, text, x, y, font, fontSize, lineHeight, maxWidth, color = (0, pdf_lib_1.rgb)(0, 0, 0), }) {
...
async function generateSafeDraftPdf({ investorName, amountCents, investorEmail, }) {
    ...
    let logoDrawn = false;
    try {
        const logoBytes = await (0, promises_1.readFile)("/Volumes/SSD/jurybrand/JuryLogo.png");
    ...
    y = drawWrappedText({
        page,
        text: "This document is a draft summary of the proposed SAFE terms based on the amount submitted through Jury. It is provided for review and discussion only and is not countersigned, final, or legally complete on its own.",
        x: margin,
        y,
        font: bodyFont,
        fontSize: 11,
    ...
    y = drawWrappedText({
        page,
        text: "If your legal name, email, or investment amount should be corrected before final paperwork is issued, reply to the SAFE draft email and we will update the agreement before execution.",
        x: margin,
        y,
        font: bodyFont,
        fontSize: 11,
    ...
    drawWrappedText({
        page,
        text: "By proceeding to final documentation, the investor acknowledges that startup investments are risky, illiquid, and may result in complete loss of capital. Final SAFE paperwork remains subject to review, approval, and countersignature.",
        x: margin,
        y,
        font: bodyFont,
        fontSize: 11,
